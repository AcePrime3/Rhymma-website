        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-display font-bold uppercase tracking-tight mb-5">
              Respecting the work behind every shipment
            </h1>
            <p className="text-base sm:text-lg text-muted-foreground leading-8">
              Rhymma was built to give logistics teams better context, stronger communication, and sharper
              execution without losing sight of the people doing the work.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-4xl mx-auto rounded-2xl border border-white/10 bg-white/[0.03] p-8 sm:p-12">
            <p className="text-base leading-8 text-muted-foreground">
              We believe the future of logistics depends on combining real operational visibility with a
              human-centered approach. Our platform is designed to help teams work with more clarity, less
