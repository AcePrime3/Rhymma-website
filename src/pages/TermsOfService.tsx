        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-base sm:text-lg text-muted-foreground leading-8">
              We are preparing these terms for publication and will add the finalized version here soon.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-4xl mx-auto rounded-2xl border border-white/10 bg-white/[0.03] p-8 sm:p-12">
            <p className="text-base leading-8 text-muted-foreground">
              This page is currently a placeholder for our future terms of service. We will publish the final
              version here once it is ready.
            </p>
          </div>
        </div>
      </section>
